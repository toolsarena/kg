...
AWS Config and IAM Access Analyzer can help during user permissions audits.
• Establish a job role matrix: A job role matrix visualizes the various roles and access levels
required within your AWS footprint. With a job role matrix, you can define and separate
